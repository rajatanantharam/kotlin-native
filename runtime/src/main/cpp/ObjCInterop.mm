...
BOOL _tryRetainImp(id self, SEL _cmd) {
  ...
  try {
    ...
    NSLog(@"ERROR: Possible illegal attempt to access weak property from non-owning thread\n"
                         "is not recoverable and is not propagated from Kotlin to Objective-C/Swift\n"
                         "Terminating now\n");
